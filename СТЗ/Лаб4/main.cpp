...
{
    //Часть 1
    Mat part1_1 = imread("part1_1.jpg", IMREAD_GRAYSCALE);
    imshow("part1_1", part1_1);
    part1(part1_1);

    Mat part1_2 = imread("part1_2.jpg", IMREAD_GRAYSCALE);
    imshow("part1_2", part1_2);
    part1(part1_2);

    Mat part1_3 = imread("part1_3.jpg", IMREAD_GRAYSCALE);
    imshow("part1_3", part1_3);
    part1(part1_3);


    //Часть 2
    Mat part2_1 = imread("part2_5.jpg");
    ...
    Mat part3_1 = imread("part3_1.jpg");
    imshow("part3_1", part3_1);
    Mat part3_1HSV;
